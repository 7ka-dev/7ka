  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          <span className="text-[0.55rem] tracking-[0.25em] uppercase" style={{ color: '#5a4a2a' }}>
            INTERNAL ACCESS TERMINAL
          </span>
          <span className="text-[0.55rem] tracking-[0.2em]" style={{ color: '#5a4a2a' }}>
        ...
        <div className="flex-1 overflow-hidden p-8">
          {activeSection === null && (
            <div
              ...
              style={{ color: '#3a2e18' }}
            >
              <div className="text-[0.6rem] tracking-[0.3em] uppercase">SELECT SECTION</div>
              <div className="text-[2rem] tracking-[0.5em]" style={{ color: '#2a2015' }}>
                ▓▓▓▓▓▓▓▓▓▓▓▓
              </div>
            </div>
          )}
          ...
          {activeSection === 'ops' && <div style={{ color: '#c8a84b' }}>OPS PLACEHOLDER</div>}
